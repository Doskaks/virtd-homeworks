...
Ссылка на hub.docker.com:
![Ссылка на hub.docker.com](https://hub.docker.com/repository/docker/doskaks/custom-nginx/general)
...
Суть предупреждения:
    ...
    Docker Compose предупреждает, что эти контейнеры больше не управляются текущим compose-файлом.

Выполняем команду с флагом --remove-orphans для очистки осиротевших контейнеров
